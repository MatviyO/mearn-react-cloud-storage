...
const FileList: FC<Props> = ({}) => {
    // const files = useSelector((state: IStateReducer) => state.files.files).map(file => <File />)
    const files = [
        {_id: 1 , name: 'name', type: 'dir', size: '5gb', date: '20.20.2020'},
        {_id: 2 , name: 'name2', type: 'came', size: '51gb', date: '44.22.2020'},
        {_id: 3 , name: 'name3', type: 'sett', size: '52gb', date: '11.33.2020'}
    ]
